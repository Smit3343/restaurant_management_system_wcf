...
namespace Restaurant_Management_Client
{
    public partial class Items : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    client1.Open();
                    List<Item> items = client1.GetItems().ToList().Take<Item>(15).ToList();
        ...
        protected void all_Command(object sender, CommandEventArgs e)
        {
            ...
            {
                List<Item> items = client.GetItems().ToList().Take<Item>(15).ToList();
            ...
            {
                category = arg;
                List<Item> items = client.getItemBycategory(arg).ToList().Take<Item>(15).ToList();
